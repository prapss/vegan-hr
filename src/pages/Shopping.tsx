        ...
        <motion.div {...revealProps} className="mb-6 bg-white rounded-xl p-6 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-600">
            <ul className="space-y-3">
              <li className="flex items-start">
                <NotepadText className="h-11 w-11 text-emerald-600 mr-3 relative bottom-2" />
                <div>
              ...
              <li className="flex items-start">
                <Plus className="h-11 w-11 text-emerald-600 mr-3 relative bottom-2" />
                <div>
                  <strong>Kupuj u rinfuzi</strong> — Žitarice, mahunarke i orašasti plodovi često su povoljniji u većim pakiranjima.
                </div>
              </li>
              <li className="flex items-start">
                <Zap className="h-11 w-11 text-emerald-600 mr-3 relative bottom-2" />
                <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <Info className="h-12 w-12 text-emerald-600 mr-3 relative bottom-3" />
                <div>
              ...
              <li className="flex items-start">
                <Archive className="h-8 w-8 text-emerald-600 mr-3 relative bottom-1" />
                <div>
