// neki prijelazni efekti
        {/* <div className="pointer-events-none absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-emerald-200/50 via-emerald-100/20 to-transparent blur-3xl" />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-16 bg-gradient-to-b from-emerald-100/40 to-emerald-50/60 " /> */}
        {/* <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(16,185,129,0.16),rgba(16,185,129,0)_55%)]" /> */}
